...
class MyListingsController: UICollectionViewController {
...
extension MyListingsController: UICollectionViewDelegateFlowLayout {
...
extension MyListingsController: PinterestLayoutDelegate {
    func collectionView(
